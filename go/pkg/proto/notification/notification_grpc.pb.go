...
func (c *notificationServiceClient) Send(ctx context.Context, in *SendRequest, opts ...grpc.CallOption) (*SendReply, error) {
...
func (UnimplementedNotificationServiceServer) Send(context.Context, *SendRequest) (*SendReply, error) {
